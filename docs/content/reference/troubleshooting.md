...
Most of these come down to network reality or how baomoi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

baomoi rate-limits like any public site. baomoi already paces
...
Where a surface is gated, baomoi reads a cookie or token you supply
...
`baomoi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what baomoi actually did
